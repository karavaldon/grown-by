      ...
      >
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="text-center w-[300px]">
            {state === 'waiting' && (
              <>
                <p className="text-[#5E44C5] text-[20px] font-bold leading-[30px]" style={{ fontFamily: 'Montserrat, sans-serif' }}>Ready for Tap or Swipe</p>
                <p className="text-[#231F20] text-[20px] leading-[30px]" style={{ fontFamily: 'Montserrat, sans-serif' }}>on your card reader</p>
              </>
            )}
            {state === 'processing' && (
              <p className="text-[#5E44C5] text-[20px] font-bold leading-[30px]" style={{ fontFamily: 'Montserrat, sans-serif' }}>Processing...</p>
            )}
            {state === 'approved' && (
